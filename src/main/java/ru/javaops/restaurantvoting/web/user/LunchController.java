...
public class LunchController {
    ...
    @GetMapping("/{date}")
    public Lunch getFromRestaurantOnDate(@PathVariable @AvailableRestaurant int restaurantId, @PathVariable LocalDate date, @AuthenticationPrincipal AuthUser authUser) {
