...
public class DishTestData {
    ...
    public static final Dish deletedDish = new Dish(2L, "Deleted Dish", 250, burgerKing, true, true);
    public static final Dish cheeseBurger = new Dish(3L, "Cheeseburger", 200, burgerKing);
    public static final Dish unavailableDish = new Dish(4L, "Unavailable Dish", 199, burgerKing, false, false);
    ...
    public static final Dish savedDish = new Dish(newDish.getName(), newDish.getPrice(), burgerKing);
